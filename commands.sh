...
ffmpeg -i plated.mp4 -vf "drawtext=fontfile=arial.ttf:text='I am learning computer graphics!':fontcolor=white:fontsize=24:x=200:y=476:enable='between(t,2,10)" result.mp4